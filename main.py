...
if __name__ == "__main__":
    ...
    parser.add_argument("tests_template_path", type=str, help="Path to tests template")
    args = parser.parse_args()

    oracle = Oracle.from_file(args.oracle_schema_path)
    contract_template = codegen.load_template_from_file(args.contract_template_path)
